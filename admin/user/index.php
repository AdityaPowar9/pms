	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					...
					<button class="btn btn-sm btn-secondary ml-2" id="printProfile"><i class="fas fa-print"></i> Print</button>
				</div>
			</div>
		</div>
</div>
...
<script>
	...
	$("#printProfile").click(function(){
		...
		document.body.innerHTML = "<html><head><title>Print Profile</title></head><body>" + printContents + "</body></html>";
		window.print();
		document.body.innerHTML = originalContents;
		location.reload(); // Restore page functionality
	});
</script>
