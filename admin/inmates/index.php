...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=inmates/manage_inmate" id="create_new" class="btn btn-flat btn-primary">
	...
	<div class="card-body">
        <div class="container-fluid">
						...
						<tr>
							...
							<td align="center">
				                ...
				                <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item view-data" href="./?page=inmates/view_inmate&id=<?php echo $row['id'] ?>">
				                    	<span class="fa fa-eye text-dark"></span> View
				                    </a>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item edit-data" href="./?page=inmates/manage_inmate&id=<?php echo $row['id'] ?>">
			...
			<div class="d-flex justify-content-between mt-3">
				...
				<div>
					<!-- DataTables Pagination appears here -->
				</div>
			</div>
